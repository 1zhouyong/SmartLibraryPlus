package com.example.smartlibrary.adapter.channel;
            ...
            public void onClick(View v) {
                ...
                if(mDatas.get(holder.getAdapterPosition()).getTypeView()==MY_CHANNEL){
                    ...
                    if(isEdit){
                        ...
                        ToastUitl.showShort(mDatas.get(holder.getAdapterPosition()).getSrc());
                    }
...
//                        开启拖动
    ...
    public List<ChannelBean> getmMyChannel() {
        return mMyChannel;
    }

    public List<ChannelBean> getmOtherChannel() {
        return mOtherChannel;
    }
}
