...
import com.example.smartlibrary.model.LectureInfoModel;
 ...
 *
 * -----------------------------------------------------------------
 * 2022/4/20 : Create LectureInfoPresenter.java
 * -----------------------------------------------------------------
 */
public class LectureInfoPresenter extends BasePresenter<LectureInfoContract.View> implements LectureInfoContract.Presenter  {
    ...
    private LectureInfoContract.Model model;

    public LectureInfoPresenter(){
        model = new LectureInfoModel();
    }



    @Override
    public void submitOrderLecture(String token, RequestBody body) {
        model.orderLecture(token,body)
                ...
                .subscribe(new Observer<BaseObjectBean<Boolean>>() {
                    ...
                    public void onNext(@NonNull BaseObjectBean<Boolean> booleanBaseObjectBean) {
                        mView.orderSuccess(booleanBaseObjectBean.getSuccess());
                    }
